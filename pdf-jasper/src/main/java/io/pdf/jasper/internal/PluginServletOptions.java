...
/**
 * 为支持bundle内部定义taglib定制此类，指定ComponentTldLocationCache为默认的TldLocationsCache
 * @author zhaob
 *
 */
public class PluginServletOptions implements Options{
	
	  	private Log logger = LogFactory.getLog(EmbeddedServletOptions.class);
	     ...
	     */
	    public PluginServletOptions(FilterConfig config,
	        ...
	        if (keepgen != null) {
	            if (keepgen.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.keepgen"));
	                }
	            }
	        }
	        ...
	        if (trimsp != null) {
	            if (trimsp.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.trimspaces"));
	                }
	            }
	        }
	        ...
	        if (poolingEnabledParam != null
	            ...
	            if (poolingEnabledParam.equalsIgnoreCase("false")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.enablePooling"));
	                }		       	   
	            }
	        }
	        ...
	        if (mapFile != null) {
	            if (mapFile.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.mappedFile"));
	                }
	            }
	        }
	        ...
	        if (debugInfo != null) {
	            if (debugInfo.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.classDebugInfo"));
	                }
	            }
	        }
	        ...
	        if (checkInterval != null) {
	            try {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.checkInterval"));
	                }
	            }
	        }
	        ...
	        if (modificationTestInterval != null) {
	            try {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.modificationTestInterval"));
	                }
	            }
	        }
	        ...
	        if (recompileOnFail != null) {
	            if (recompileOnFail.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.recompileOnFail"));
	                }
	            }
	        }
	        ...
	        if (development != null) {
	            if (development.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.development"));
	                }
	            }
	        }
	        ...
	        if (suppressSmap != null) {
	            if (suppressSmap.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.suppressSmap"));
	                }
	            }
	        }
	        ...
	        if (dumpSmap != null) {
	            if (dumpSmap.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.dumpSmap"));
	                }
	            }
	        }
	        ...
	        if (genCharArray != null) {
	            if (genCharArray.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.genchararray"));
	                }
	            }
	        }
	        ...
	        if (errBeanClass != null) {
	            if (errBeanClass.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.errBean"));
	                }
	            }
	        }
	        ...
	        if (this.scratchDir == null) {
	            logger.fatal(Localizer.getMessage("jsp.error.no.scratch.dir"));
	            return;
	        }
	        
	        if (!(scratchDir.exists() && scratchDir.canRead() &&
	                scratchDir.canWrite() && scratchDir.isDirectory()))
	            logger.fatal(Localizer.getMessage("jsp.error.bad.scratch.dir",
	        ...
	        if (fork != null) {
	            if (fork.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.fork"));
	                }
	            }
	        }
	        ...
	        if (xpoweredBy != null) {
	            if (xpoweredBy.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.xpoweredBy"));
	                }
	            }
	        }
	        ...
	        if (displaySourceFragment != null) {
	            if (displaySourceFragment.equalsIgnoreCase("true")) {
	                ...
	                if (logger.isWarnEnabled()) {
	                    logger.warn(Localizer.getMessage("jsp.warning.displaySourceFragment"));
	                }
	            }
	        }
	        ...
	        // web-application.
	        tldLocationsCache = new PluginTldLocationsCache(context);
