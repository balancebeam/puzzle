...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private void init() {
        ...
        if (ProtocolUtils.isGeneric(getGeneric())) {
            ...
            try {
				interfaceClass = Class.forName(interfaceName, true, getClassLoader());
    ...
    /**
     * 定义个getClassLoader方法，用于加载interface
     * 此方法被ReferenceBean覆盖，获取ApplicationContext的ClassLoader
     * @return
     */
	...
	public Class<?> getInterfaceClass() {
	    ...
	    try {
	        if (interfaceName != null && interfaceName.length() > 0) {
	        	//Override use plugin classloader to load inerface
	            this.interfaceClass = Class.forName(interfaceName, true, getClassLoader());
	        }
